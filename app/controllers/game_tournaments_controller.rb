  ...
  def create
    ...
    respond_to do |format|
      if @game_tournament.save
        ...
        format.html { redirect_to game_tournament_url(@game_tournament), notice: "tournament was successfully created." }
  ...
  def update
    respond_to do |format|
      if @game_tournament.update(game_tournament_params)
        format.html { redirect_to game_tournament_url(@game_tournament), notice: "tournament was successfully updated." }
        format.json { render :show, status: :ok, location: @game_tournament }
      else
